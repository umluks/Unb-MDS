...
* [Excluir Prontuário](#excluir-prontuário) [26]{.n}

* [Identificação da pessoa de referência e endereço da família](#identificação-da-pessoa-de-referência-e-endereço-da-família) [27]{.n}

* [Informações da família](#informações-da-família) [30]{.n}

* [Composição familiar (quadro)](#composição-familiar-quadro) [31]{.n}

* [Forma de ingresso na unidade e motivo do primeiro atendimento](#forma-de-ingresso-na-unidade-e-motivo-do-primeiro-atendimento) [32]{.n}

* [Composição familiar (bloco)](#composição-familiar-bloco) [40]{.n}

* [Condições habitacionais da família](#condições-habitacionais-da-família) [42]{.n}

* [Condições educacionais da família](#condições-educacionais-da-família) [49]{.n}

* [Condições de saúde da família](#condições-de-saúde-da-família) [51]{.n}

* [Condições de trabalho e rendimento da família](#condições-de-trabalho-e-rendimento-da-família) [56]{.n}

**[Registro de atendimentos socioassistenciais](#registro-de-atendimentos-socioassistenciais)** [59]{.n}

* [Acesso a benefícios eventuais](#acesso-a-benefícios-eventuais) [66]{.n}

* [Convivência familiar e comunitária](#convivência-familiar-e-comunitária) [72]{.n}

* [Situações de vulnerabilidades e desproteções sociais da família](#situações-de-vulnerabilidades-e-desproteções-sociais-da-família) [73]{.n}

* [Situações de violência e violação de direitos](#situações-de-violência-e-violação-de-direitos) [83]{.n}

* [Planejamento e evolução do acompanhamento familiar](#planejamento-e-evolução-do-acompanhamento-familiar) [84]{.n}

* [Participação em serviços, programas e projetos](#participação-em-serviços-programas-e-projetos) [92]{.n}

* [Histórico de cumprimento de medidas socioeducativas](#histórico-de-cumprimento-de-medidas-socioeducativas) [93]{.n}

* [Histórico de acolhimento institucional](#histórico-de-acolhimento-institucional) [101]{.n}

* [Formulário de controle de encaminhamentos](#formulário-de-controle-de-encaminhamentos) [102]{.n}

* [Relatório de participação em atendimentos coletivos](#relatório-de-participação-em-atendimentos-coletivos) [113]{.n}

* [Relatório simplificado dos atendimentos](#relatório-simplificado-dos-atendimentos) [116]{.n}

**[Prontuário: Atendimento Coletivo](#prontuário-atendimento-coletivo)** [117]{.n}

**[Prontuário: Migrar Prontuário](#prontuário-migrar-prontuário)** [129]{.n}

**[Prontuário: Painel Estatístico](#prontuário-painel-estatístico)** [140]{.n}
...
<kbd>1</kbd> Na tela do *login* gov.br, informe o número do CPF (número pessoal e único de 11 dígitos), senha e acione a opção <kbd>2</kbd> **Continuar**.

O sistema apresenta a tela Autorização de uso de dados pessoais:

![Autorização de uso de dados pessoais](img/login-no-sistema-2.png){.w-90}
...
![Selecionar o Perfil](img/login-no-sistema-3.png){.w-80}
...
Uma vez realizada a autenticação no sistema, você pode verificar <kbd>1</kbd> **no canto superior da tela inicial**, o CPF, o nome e o *avatar* do usuário logado.

Ao acionar o <kbd>2</kbd> **ícone do avatar**, é possível verificar a <kbd>3</kbd> **unidade de atendimento** e o <kbd>4</kbd> **perfil**. Nesta funcionalidade, também é possível <kbd>5</kbd> **trocar de perfil** (caso o usuário possua mais de um perfil) ou <kbd>6</kbd> **sair do sistema** (*logout*).
...
![Consulta avançada](img/realizar-atendimento-3.png){.img-pagina}
...
Preencha os dados solicitados e acione a opção <kbd>5</kbd> **Incluir**, em seguida o sistema fecha a janela, atualiza a lista de observações e apresenta a mensagem *"Observação incluída com sucesso"*.
...
Para **editar a observação**, acione a opção <kbd>3</kbd> **Alterar observação**, então o sistema vai apresentar a janela com os campos habilitados. Informe os ajustes e acione a opção <kbd>6</kbd> **Alterar**, em seguida o sistema fecha a janela, atualiza a lista de atendimentos e apresenta a mensagem *"Observação alterada com sucesso"*.

![Alterar observação](img/aspectos-globais-do-modulo-prontuario-4.png){.w-80}

Para **excluir o registro de observação da lista**, acione a opção <kbd>4</kbd> **Excluir observação**, e o sistema solicitará a confirmação da ação. Caso confirmada, o sistema atualiza a lista e apresenta a mensagem *"Observação excluída com sucesso"*.
...
Preencha os dados solicitados e acione a opção <kbd>7</kbd> **Incluir**, em seguida o sistema fecha a janela, atualiza a lista de atendimentos e apresenta a mensagem *"Registro de atendimento incluído com sucesso"*.
...
### Adicionar registro *(continuação)*
...
### Visualizar registro *(continuação)*
...
Informe os ajustes e acione a opção <kbd>7</kbd> **Alterar**, em seguida o sistema fecha a janela, atualiza a lista de atendimentos e apresenta a mensagem *"Forma de ingresso na unidade alterada com sucesso"*.
...
Para **excluir o registro da lista**, acione a opção <kbd>5</kbd> **Excluir forma de ingresso**, e o sistema solicitará a confirmação da ação. Caso confirmada, o sistema atualiza a lista e apresenta a mensagem *"Forma de ingresso excluída com sucesso"*.
...
Para **adicionar informações de habitação**, acione a opção <kbd>4</kbd> **Incluir habitação**, então o sistema vai apresentar a janela para cadastro. Preencha os dados solicitados e acione a opção <kbd>8</kbd> **Incluir**, em seguida o sistema fecha a janela, apresenta as Condições habitacionais da família e a mensagem *"Condições habitacionais incluída com sucesso"*.

![Incluir Habitação](img/condicoes-habitacionais-da-familia-3.png){.w-60}
...
Para **editar as informações de habitação**, acione a opção <kbd>5</kbd> **Atualizar habitação**, então o sistema vai apresentar a janela com os campos habilitados. Informe os ajustes e acione a opção <kbd>8</kbd> **Incluir**, em seguida o sistema fecha a janela, atualiza as Condições habitacionais da família e apresenta a mensagem *"Condições habitacionais atualizadas com sucesso"*.

![Atualizar Habitação](img/condicoes-habitacionais-da-familia-4.png){.w-60}
...
### Atualizar habitação *(continuação)*
...
Preencha os dados solicitados e acione a opção <kbd>9</kbd> **Incluir**, em seguida o sistema fecha a janela, atualiza a lista de marcações e apresenta a mensagem *"Condição de saúde incluída com sucesso"*.
...
### Incluir marcações de saúde *(continuação)*
...
Informe os ajustes e acione a opção <kbd>9</kbd> **Atualizar**, em seguida o sistema fecha a janela, atualiza a lista de marcações e apresenta a mensagem *"Condição de saúde alterada com sucesso"*.
...
Para **excluir marcação de saúde**, acione a opção <kbd>6</kbd> **Excluir marcação**, e o sistema solicitará a confirmação da ação. Caso confirmada, o sistema atualiza a lista e apresenta a mensagem *"Marcação excluída com sucesso."*.
...
![Incluir Atendimento](img/registro-de-atendimentos-socioassistenciais-2.png){.w-100}
...
### Incluir atendimento *(continuação)*
...
### Visualizar atendimento *(continuação)*
...
![Janela Editar Atendimento](img/registro-de-atendimentos-socioassistenciais-4.png){.w-100}
...
### Editar atendimento *(continuação)*
...
Preencha os dados solicitados e acione a opção <kbd>9</kbd> **Incluir**, em seguida o sistema fecha a janela, atualiza a lista de benefícios e apresenta a mensagem *"Benefício eventual incluído com sucesso"*.
...
### Incluir benefício eventual *(continuação)*
...
Informe os ajustes e acione a opção <kbd>9</kbd> **Atualizar**, em seguida o sistema fecha a janela, atualiza a lista de benefícios e apresenta a mensagem *"Benefício eventual alterado com sucesso"*.
...
### Editar benefício eventual *(continuação)*
...
Para **excluir o benefício da lista**, acione a opção <kbd>6</kbd> **Excluir benefício**, e o sistema solicitará a confirmação da ação. Caso confirmada, o sistema atualiza a lista e apresenta a mensagem *"Benefício eventual excluído com sucesso"*.
...
Para **adicionar uma nova vulnerabilidade**, acione a opção <kbd>4</kbd> **Incluir vulnerabilidade**, então o sistema vai apresentar a janela para cadastro. Preencha os dados solicitados e acione a opção <kbd>11</kbd> **Incluir**, em seguida o sistema salva o registro, fecha a janela, atualiza a lista e apresenta a mensagem *"Situação de vulnerabilidade incluída com sucesso"*.
...
### Incluir vulnerabilidade *(continuação)*
...
### Visualizar registro de vulnerabilidade *(continuação)*
...
Informe os ajustes e acione a opção <kbd>13</kbd> **Alterar**, em seguida o sistema salva a alteração do registro, atualiza a lista e apresenta a mensagem *"Atualização incluída com sucesso"*.
...
### Editar registro de vulnerabilidade da lista na janela *(continuação)*
...
Para **excluir atualização de vulnerabilidade da lista na janela**, acione a opção <kbd>12</kbd> **Excluir vulnerabilidade**, e o sistema solicitará a confirmação da ação. Caso confirmada, o sistema atualiza a lista e apresenta a mensagem *"Situação de vulnerabilidade excluída com sucesso"*.
...
Informe os dados e acione a opção <kbd>13</kbd> **Atualizar**, em seguida o sistema salva a alteração do registro, fecha a janela, atualiza a lista e apresenta a mensagem *“Atualização incluída com sucesso”*.
...
### Atualizar registro de vulnerabilidade *(continuação)*
...
Informe os ajustes e acione a opção <kbd>13</kbd> **Atualizar**, em seguida o sistema salva a alteração do registro, fecha a janela, atualiza a lista e apresenta a mensagem *“Atualização incluída com sucesso”*.
...
Para **excluir o registro** de vulnerabilidade da lista, acione a opção <kbd>8</kbd> **Excluir vulnerabilidade**, e o sistema solicitará a confirmação da ação. Caso confirmada, o sistema atualiza a lista e apresenta a mensagem *"Atualização excluída com sucesso"*.
...
Para **adicionar a família ao acompanhamento**, acione a opção <kbd>3</kbd> **Incluir acompanhamento**. Então, o sistema vai apresentar a janela para cadastro. Preencha os dados solicitados e acione a opção <kbd>9</kbd> **Incluir**. Em seguida, o sistema salva o registro, fecha a janela, atualiza a lista e apresenta a mensagem *"Acompanhamento familiar incluído com sucesso"*.
...
### Incluir acompanhamento *(continuação)*
...
### Visualizar acompanhamento *(continuação)*
...
Informe os ajustes e acione a opção <kbd>9</kbd> **Alterar**, em seguida o sistema salva a alteração do registro, fecha a janela, atualiza a lista e apresenta a mensagem *"Acompanhamento familiar alterado com sucesso"*.
...
### Editar acompanhamento *(continuação)*
...
Para **excluir o registro** de acompanhamento familiar da lista, acione a opção <kbd>6</kbd> **Excluir acompanhamento**. O sistema solicitará a confirmação da ação e, caso confirmada, o sistema exclui o registro, atualiza a lista e apresenta a mensagem *"Acompanhamento familiar excluído com sucesso"*.
...
Preencha os dados solicitados e acione a opção <kbd>9</kbd> **Incluir**, em seguida o sistema fecha a janela, atualiza a lista de observações e apresenta a mensagem “*Medida socioeducativa incluída com sucesso*”.
...
### Incluir medida socioeducativa *(continuação)*
...
### Visualizar medida socioeducativa *(continuação)*
...
Informe os ajustes e acione a opção <kbd>9</kbd> **Alterar**, em seguida o sistema fecha a janela, atualiza a lista e apresenta a mensagem “*Medida socioeducativa alterada com sucesso*”.
...
### Editar medida socioeducativa *(continuação)*
...
Para **excluir o registro de medida socioeducativa**, acione a opção <kbd>6</kbd> **Excluir medida**, e o sistema solicitará a confirmação da ação. Caso confirmada, o sistema atualiza a lista e apresenta a mensagem “*Medida socioeducativa excluída com sucesso*”.
...
![Visualizar encaminhamento](img/formulario-de-controle-de-encaminhamentos-9.png){.w-80}
...
![Editar encaminhamento](img/formulario-de-controle-de-encaminhamentos-12.png){.w-80}
...
Preencha os dados solicitados e acione a opção <kbd>12</kbd> **Incluir**, em seguida o sistema fecha a janela, atualiza a lista de atendimento coletivo da unidade e apresenta a mensagem “*Atendimento coletivo incluído com sucesso*”.
...
### Incluir atendimento coletivo *(continuação)*
...
![Visualizar atendimento coletivo](img/prontuario-atendimento-coletivo-4.png){.w-70}
...
### Visualizar atendimento coletivo *(continuação)*
...
![Editar atendimento coletivo](img/prontuario-atendimento-coletivo-5.png){.w-60}
...
### Editar atendimento coletivo *(continuação)*

Informe os ajustes e acione a opção <kbd>12</kbd> **Alterar**, em seguida o sistema fecha a janela, atualiza a lista e apresenta a mensagem “*Atendimento coletivo alterado com sucesso*”.
...
Para **excluir o registro de atendimento coletivo**, acione a opção <kbd>10</kbd> **Excluir atendimento coletivo**, e o sistema solicitará a confirmação da ação. Caso confirmada, o sistema atualiza a lista e apresenta a mensagem “*Atendimento coletivo excluído com sucesso*”.
...
Informe os ajustes e acione a opção <kbd>12</kbd> **Incluir**, em seguida o sistema fecha a janela, atualiza a lista e apresenta a mensagem “*Atendimento coletivo alterado com sucesso*”.
...
### Duplicar atendimento coletivo *(continuação)*
