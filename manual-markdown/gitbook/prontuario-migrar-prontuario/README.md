...
![Selecionar Unidade](../img/prontuario-migrar-prontuario-1.png)
...
![Aprovação de pedido de migração](../img/prontuario-migrar-prontuario-2.png)
...
![Aprovar migração](../img/prontuario-migrar-prontuario-3.png)

A janela ➒ **Aprovar migração** é composta por:

- **Texto informativo**: *"Ao confirmar a operação, o prontuário da pessoa/família será migrado para a unidade solicitante"*;
