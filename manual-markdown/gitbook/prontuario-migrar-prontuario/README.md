...
O sistema apresentará a funcionalidade <kbd>2</kbd> **Selecionar unidade**, listando as unidades atribuídas ao usuário conforme perfil no CadSUAS.

![Selecionar Unidade](img/migrar-prontuario-1.png)

A <kbd>3</kbd> **lista de unidades de atendimento** é composta por:
...
![Aprovação de pedido de migração](img/migrar-prontuario-2.png)

Aprovação de pedido de migração O sistema apresentará a funcionalidade <kbd>6</kbd> Aprovação de pedido de migração com a lista de prontuários aguardando análise.
...
![Visualizar solicitação de migração](img/migrar-prontuario-modal-1.png)
...
- **Data de abertura:** campo que informa a data de abertura do prontuário da pessoa;
- **Unidade atual:** campo que informa o nome da unidade de atendimento atual;
- **Município:** campo que informa o município e o estado da unidade de atendimento atual.
...
- **Município/UF:** campo que informa o município e a UF da residência da pessoa/família;
- **CEP:** campo que informa o número do CEP da residência da pessoa/família;
- **Motivo:** campo destinado a informar o motivo da solicitação de migração do prontuário da pessoa/família;
- **Nome do técnico responsável:** campo que informa o nome do técnico responsável pela migração;
- **Situação:** campo que informa a situação da solicitação de migração;
...
Para aprovar a migração, acione a opção <kbd>9</kbd> **Prosseguir para aprovação** na janela <kbd>8</kbd> **Visualizar solicitação de migração** ou na coluna ações.

![Aprovar migração](img/migrar-prontuario-modal-2.png)

A janela <kbd>9</kbd> **Aprovar migração**,representada na página anterior, de prontuário eletrônico é composta por:

- **Texto informativo** "Ao confirmar a operação, o prontuário da pessoa e demais membros da família serão migrados para unidade de destino."
...
- **CEP:** campo que informa o número do CEP da residência da pessoa/família;
- **Motivo:** campo que informa o motivo da solicitação de migração do prontuário;
- **Nome do técnico responsável:** campo que informa o nome do técnico responsável pela migração;
...
![Aprovar todos](img/migrar-prontuario-modal-3.png)
