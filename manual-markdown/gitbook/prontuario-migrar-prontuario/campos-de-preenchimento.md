...
* **Texto informativo** - “_Ao confirmar a operação, o prontuário da pessoa e demais membros da família serão migrados para uma unidade de destino._”
...
* **Nome do técnico responsável** – campo que informa o município/ UF da residência da pessoa/ família;
...
A janela <kbd>10</kbd> **Aprovar migração** de prontuário eletrônico é composta por:

* **Texto informativo** - “_Ao confirmar a operação, o prontuário da pessoa e demais membros da família serão migrados para a unidade de destino._”
