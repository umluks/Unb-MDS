...
![Duplicar atendimento coletivo](../img/prontuario-atendimento-coletivo-6.png)

Informe os ajustes e acione a opção **Incluir**, em seguida o sistema fecha a janela, atualiza a lista e apresenta a mensagem *"Atendimento coletivo alterado com sucesso"*.

A janela **Incluir atendimento coletivo** (ao clonar) possui os seguintes campos:
