...
Para visualizar o atendimento coletivo, acione a opção ➑ **Visualizar atendimento coletivo** na coluna ação, então o sistema vai apresentar a janela com as informações.
