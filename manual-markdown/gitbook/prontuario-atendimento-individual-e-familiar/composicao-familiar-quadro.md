...
* **Situação cadastral** – Campo que informa a situação (Em Cadastramento, Sem Registro Civil, Cadastrado, Excluído, Aguardando NIS e Validando NIS) do cadastro do membro da composição familiar no Cadastro Único;
...
![Composição Familiar](../../../.gitbook/assets/informacoes-de-identificacao-da-pessoa-4.png)
