...
Para adicionar uma nova observação, acione a opção ➌ **Incluir observação**, então o sistema vai apresentar a janela para cadastro. Preencha os dados solicitados e acione a opção ➑ **Incluir**, em seguida o sistema fecha a janela, atualiza a lista de atendimento coletivo e apresenta a mensagem *"Observação incluída com sucesso."*.
