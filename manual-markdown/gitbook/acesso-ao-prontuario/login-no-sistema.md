...
![Login gov.br](login-no-sistema-1.png)

1. Na tela do *login* gov.br, informe o número do CPF (número pessoal e único de 11 dígitos), senha e acione a opção <kbd>2</kbd> **Continuar**.

O sistema apresenta a tela Autorização de uso de dados pessoais:

![Autorização de uso de dados pessoais](login-no-sistema-2.png)
...
![Selecionar o Perfil](login-no-sistema-3.png)
...
![Tela inicial e Menu do Avatar](login-no-sistema-4.png)
