...
* **Situação Cadastral** – Campo que informa a situação (Em Cadastramento, Sem Registro Civil, Cadastrado, Excluído, Aguardando NIS e Validando NIS) do cadastro da pessoa no Cadastro Único;
* **Data de Nascimento** – Campo que informa a data de nascimento da pessoa;
* **Nome da Mãe** – Campo que informa o nome da mãe da pessoa;

![Identificação da Pessoa de Referência](../../../.gitbook/assets/informacoes-de-identificacao-da-pessoa-1.png)

***

## Dados Pessoais

Conforme tela, a funcionalidade **Dados Pessoais** é composta pelos campos:
...
![Dados Pessoais](../../../.gitbook/assets/informacoes-de-identificacao-da-pessoa-2.png)

***

## Dados do Endereço

Conforme tela, a funcionalidade **Dados do Endereço** é composta pelos campos:
...
![Endereço da Família](<../../../.gitbook/assets/identificacao-da-pessoa-de-referencia-e-endereco-da-familia-1 (1).png>)
